...
import com.example.mygrocerystore.activities.DeliveryFullOrderActivity;
...
public class DeliveryOrderAdapter extends RecyclerView.Adapter<DeliveryOrderAdapter.ViewHolder> {
    ...
    public DeliveryOrderAdapter(Context context, List<FullOrderModel> fullOrderModelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new DeliveryOrderAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.delivery_cart_item, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.viewCarItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, DeliveryFullOrderActivity.class);
