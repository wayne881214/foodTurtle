...
import com.example.mygrocerystore.activities.OrderActivity;
...
public class CustomerOrderAdapter extends RecyclerView.Adapter<CustomerOrderAdapter.ViewHolder> {
    ...
    public CustomerOrderAdapter(Context context, List<MyCartModel> cartModelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CustomerOrderAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.my_cart_item, parent, false));
    }
